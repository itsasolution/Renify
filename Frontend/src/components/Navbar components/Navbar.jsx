...
export const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Nav links */}
      <div className={`flex`}>
        <div className="hidden md:flex justify-evenly items-center gap-3 md:min-w-[650px] ">
          {nav}
        </div>

        {/* theme for small mobile */}
        <label
          title="Change Theme"
          className="md:hidden relative grid justify-between text-[16px] md:ml-0 md:p-0 md:items-center swap swap-rotate mr-4"
        >
          <input type="checkbox" className="hidden" />
          <span
            className="w-36 swap-off md:w-auto"

const BookingCard = ({ data, status, user }) => {
  ...
  return (
    <div className="group cardanime floatEffect relative pb-2 z-10 w-auto min-w-44 max-w-[70vw] lg:max-w-[300px] rounded-xl m-1.5 h-full overflow-hidden bg-gradient-to-br from-white  via-sky-50 to-sky-100 dark:bg-gradient-to-bl  dark:from-[#00293f] dark:via-blue-950 dark:to-slate-950  duration-200 hover:-translate-y-[2px] dark:hover:ring-green-400 dark:ring-2 dark:hover:ring-2 ring-white  ">
      ...
      <div className="flex-col px-3 py-1 mt-1 relative">
        ...
        <div className="rating">
          {/* rating */}
          <div className="flex md:hidden items-center mb-1 space-x-1 ">
            <span className="mr-1 ">{data?.overallRating}</span>
            <svg
              className="w-4 h-4 text-yellow-400 dark:text-yello-300"
              aria-hidden="true"
          ...
          <div className="md:flex hidden items-center mb-1 space-x-1 ">
            <span className="mr-1">{data?.overallRating}</span>

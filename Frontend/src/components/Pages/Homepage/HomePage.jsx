    ...
    <>
      ...
      <div className="opacityanime md:h-screen duration-300 overflow-hidden md:overflow-visible ">
        <div className="group relative flex flex-col-reverse justify-center h-[90%] md:flex-row items-center pt-7 md:pt-8 mb-10 md:mx-5 duration-300 ">
          {/* effect */}
          <span className="absolute bg-gradient-to-br from-cyan-500/80 to-cyan-300/70 shadow-sm pointer-events-none left-[48.5%] top-[40%] z-0 h-4 w-4 md:h-12 md:w-12 rounded-full duration-500 opacity-0 group-hover:opacity-100 group-hover:scale-[21] "></span>
          <span className="absolute bg-gradient-to-tl from-cyan-500/80 to-cyan-300/70 shadow-sm pointer-events-none left-[48.5%] top-[40%] z-0 h-4 w-4 md:h-12 md:w-12 rounded-full duration-300 opacity-0 group-hover:opacity-100 group-hover:scale-[25]  "></span>

...
const CarCard = ({ data }) => {
  ...
  return (
    <div className="group relative z-10 w-auto min-w-60 max-w-80 shadow-[0_1px_10px_0px_rgba(0,0,0,0.3)] rounded-xl m-1.5 h-full overflow-hidden bg-[#f8feff]/60 dark:bg-[#00293f]/50 duration-200 hover:-translate-y-1 dark:hover:ring-green-400 dark:ring-1 hover:ring-2 ring-white  ">

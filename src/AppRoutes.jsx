  ...
  return (
    <>
      ...
      <div className="hidden z-0 pointer-events-none dark:block relative h-full w-full bg-slate-950">
        <div className=" hidden md:block fixed left-[-20%] top-[0%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,rgba(255,0,182,.15),rgba(255,255,255,0))]"></div>
